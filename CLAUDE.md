...
- Reference docs: [docs/ordering-saga-flows.md](docs/ordering-saga-flows.md) (saga event flows), [docs/OUTBOX_LIFECYCLE.md](docs/OUTBOX_LIFECYCLE.md) (outbox relay lifecycle), [docs/PERSISTENT_JOB_LIFECYCLE.md](docs/PERSISTENT_JOB_LIFECYCLE.md) (persistent job lifecycle), [docs/KAFKA_GUIDE.md](docs/KAFKA_GUIDE.md) (Kafka topic/consumer/testing), [docs/adr/](docs/adr/) (ADRs)
