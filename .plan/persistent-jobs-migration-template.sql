-- Persistent job system migration template.
--
-- Copy this file into your service's migrations directory (e.g., migrations/000X_persistent_jobs.sql).
-- No modifications needed — the table, indexes, and triggers are service-agnostic.
--
...
--           registry.register(Arc::new(MyJobHandler::new(infra.require_db().clone())));
--           registry
--       })
